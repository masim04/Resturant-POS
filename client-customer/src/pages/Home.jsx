...
const SERVICES = [
  { label: "Online Order", icon: "M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17M17 13v4a2 2 0 01-2 2H9a2 2 0 01-2-2v-4" },
  { label: "Pre-Reservation", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
  { label: "24/7 Service", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
  { label: "Foodie Place", icon: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0a1 1 0 01-1-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 01-1 1" },
  { label: "Clean Kitchen", icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" },
  { label: "Super Chef", icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" },
];
...
function SectionArrows({ onPrev, onNext }) {
  return (
    <div className="flex gap-2">
      <button type="button" onClick={onPrev} className="arrow-btn" aria-label="Previous">
        <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
        </svg>
      </button>
      <button type="button" onClick={onNext} className="arrow-btn" aria-label="Next">
        <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className="min-h-screen bg-cream">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="space-y-8">
            ...
            <p className="max-w-lg text-base leading-relaxed text-ink-700 sm:text-lg">
              Cafe Rubab brings fresh café favourites to Rutherglen — browse our menu, order online, and enjoy
              delicious food made with care. Collection or delivery, your choice.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link to="/menu" className="btn-primary px-8 py-3.5 text-base">
                Order Now
              </Link>
              <a href="#menu-pack" className="btn-outline gap-2 px-8 py-3.5 text-base">
                <svg className="h-5 w-5 text-cafe-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
          ...
          <div className="relative flex items-center justify-center lg:justify-end">
            <div className="hero-glow pointer-events-none absolute h-105 w-105 rounded-full" aria-hidden />
            <div className="relative flex items-center gap-4 sm:gap-6">
              <div className="relative h-64 w-64 shrink-0 overflow-hidden rounded-full border-8 border-white shadow-cafe-lg sm:h-80 sm:w-80">
                <img src={HERO_IMG} alt="Fresh healthy bowl" className="h-full w-full object-cover" />
              </div>
              <ul className="hidden flex-col gap-3 sm:flex">
                {HERO_CATEGORIES.map((cat) => (
                  ...
                  >
                    <span className="grid h-10 w-10 place-items-center rounded-full bg-cafe-100 text-lg">{cat.icon}</span>
      ...
      <section id="popular" className="landing-container py-12 sm:py-16">
        <div className="mb-8 flex items-end justify-between gap-4">
          ...
          <SectionArrows onPrev={() => scrollPopular(-1)} onNext={() => scrollPopular(1)} />
        </div>
      ...
      <section id="about" className="landing-container py-12 sm:py-16">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            <h2 className="section-heading">We Are More Than Multiple Service</h2>
            <p className="mt-4 text-base leading-relaxed text-ink-700">
              At Cafe Rubab we combine a welcoming café atmosphere with fast online ordering. From morning coffee to
              hearty dinners, we&apos;re your local spot in Rutherglen for food you&apos;ll love.
            </p>
      ...
      <section id="reservation" className="landing-container py-12 sm:py-16">
        <div className="grid items-center gap-10 overflow-hidden rounded-4xl bg-cream p-8 sm:p-12 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <p className="mt-4 text-base leading-relaxed text-ink-700">
              Planning a meal out or a special evening? Get in touch to reserve your table at Cafe Rubab — or order
              online for collection and delivery anytime.
            </p>
          ...
          <div className="relative flex justify-center">
            <div className="hero-glow absolute h-72 w-72 rounded-full" aria-hidden />
