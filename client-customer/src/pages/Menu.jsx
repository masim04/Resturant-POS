...
function Menu() {
  ...
  return (
    <div className="min-h-screen pb-24">
      <Helmet>
        <title>Menu | Cafe Rubab</title>
        <meta
          name="description"
          content="Browse the Cafe Rubab menu featuring authentic Pakistani dishes."
        />
      </Helmet>
      <CustomerNavbar />
      <div className="container mx-auto px-4 py-8 sm:px-6 sm:py-10">
        <div className="card-surface mb-8 overflow-hidden shadow-cafe-lg sm:mb-10">
          <div className="relative bg-cream p-6 sm:p-10">
            <div
              className="pointer-events-none absolute -right-16 -top-16 h-56 w-56 rounded-full bg-cafe-300/25 blur-3xl"
              aria-hidden
            />
            <div className="relative flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-2xl space-y-4">
                <p className="text-xs font-semibold uppercase tracking-[0.28em] text-cafe-700">
                  Menu
                </p>
                ...
                <p className="text-base leading-relaxed text-ink-700 sm:text-lg">
                  Filter by category, search by name, then add to cart. Your
                  running total stays visible in the header and on the floating
                  cart button.
                </p>
              </div>
              <Link
        ...
        <TodaysOffers products={products} onAddToCart={handleAddToCart} />
                  ...
                  <div className="flex flex-1 flex-col gap-3 sm:flex-row sm:justify-between">
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-2 line-clamp-3 text-sm leading-relaxed text-ink-700">
                        {p.description ||
                          "A delicious option from our kitchen."}
                      </p>
                    </div>
        ...
        >
          ...
          Cart
          {cartCount > 0 && (
            <span className="rounded-full bg-cafe-100 px-2 py-0.5 text-xs font-bold text-cafe-800">
              {cartCount}
            </span>
          )}
        </Link>
